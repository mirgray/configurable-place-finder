...
dojo.declare("js.Config", null, {
    ...
    ApplicationIcon: "images/deer_viewing.png",

    // Set application Favicon path
    ApplicationFavicon: "images/deer_viewing.ico",

    // Set application theme
    ApplicationTheme: "styles/brownTheme.css",

    // Set splash window content - Message that appears when the application starts
    SplashScreen: {
         Message: "<center><b>Wildlife Management Area Locator</b></center><hr></br> The <b>Wildlife Management Area Locator</b> helps you locate a specific WMA and determine what wildlife exists within the WMA.<br><br> To locate a WMA, simply enter an address, name, select activities, or use your current location. The WMA(s)  will then be highlighted on the map and relevant information about each site will be presented to the user.",
        isVisible: true
    },
    ...
    FacilityLayer: "http://arcgis-gov-1244222493.us-west-2.elb.amazonaws.com/arcgis/rest/services/WMAPoints/FeatureServer/0",
    ...
    CommentsLayer: {
        ...
        URL: "http://arcgis-gov-1244222493.us-west-2.elb.amazonaws.com/arcgis/rest/services/WMAPoints/FeatureServer/1"
    },
    ...
    ReferenceOverlayLayer: {
        ServiceUrl: "http://arcgis-gov-1244222493.us-west-2.elb.amazonaws.com/arcgis/rest/services/WMABoundaries/MapServer",
        DisplayOnLoad: false
    },
    ...
    InfoWindowHeader: [{
        FieldName: "${NAME}",
        Alias: "WMAName",
        InfoWindowHeaderText: "Wildlife Management Area Name"
    }],
    ...
    Activities: [{
        FieldName: "${BIGGME}",
        Alias: "Big Game",
        Image: "images/bear_viewing.png",
        isSelected: true
    }, {
        FieldName: "${SMALLGME}",
        Alias: "Small Game",
        Image: "images/deer_viewing.png"
    }, {
        FieldName: "${WATERFWL}",
        Alias: "Waterfowl",
        Image: "images/waterfowl.png"
    }, {
        FieldName: "${BIGGMEPT}",
    ...
    LocatorSettings: {
        ...
        Locators: [{
            ...
            DisplayText: "WMA Name",
            LocatorDefaultFeature: "Percy Priest WMA"
        }, {
